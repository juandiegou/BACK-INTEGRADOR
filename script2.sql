...
CREATE TABLE "Permissions" (
    ...
    CONSTRAINT "FK_Permissions_Users_UserModelId" FOREIGN KEY ("UserModelId") REFERENCES "Users" ("Id")
);
...
CREATE INDEX "IX_Permissions_UserModelId" ON "Permissions" ("UserModelId");
